...
SKU Foundry 是一款面向电商品牌、产品设计师和营销团队的浏览器端 SPA 应用。提供从 **素材上传 → Studio 设计 → AI 合成 → 导出下载** 的完整工作流，v1.1.0 专注于 **Qwen** 和 **Doubao** 两家供应商的原生多图融合能力。
...
| 阿里 Qwen | Qwen-Image 2.0 Pro | 原生多图融合、文生图（T2I） |

### 生成流程

v1.1.0 统一使用 **原生多图融合** 模式：将产品图 + Logo 图 + 文字指令直接传入 AI 模型，一步生成融合后的 Mockup，无需中间文字描述，信息零损失。
