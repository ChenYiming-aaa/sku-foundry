...
SKU Foundry 是一款面向电商品牌、产品设计师和营销团队的浏览器端 SPA 应用。提供从 **素材上传 → Studio 设计 → AI 合成 → 导出下载** 的完整工作流，v1.2.1 新增随机开场动画及 Light Burst 效果。
...
> AI 融合功能需在右上角「AI 设置」中配置对应供应商的 API Key 后方可使用；其余素材上传、画布设计等均可直接体验。
...
v1.2.1 引入随机开场动画系统：每次启动在 Bar Reveal（竖条揭幕）和 Light Burst（玻璃核心 + 粒子群 + 光爆）之间随机选择。AI 融合功能保持 **原生多图融合** 模式。
